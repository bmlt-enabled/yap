        ...
        <div class="col-md">
            <div class="jumbotron">
                ...
                <div class="btn-group-lg">
                    ...
                    <a target="_blank" class="btn btn-info btn-md" href="https://github.com/radius314/yap/blob/master/RELEASENOTES.md" role="button"><?php echo $GLOBALS['release_notes']?></a>
                </div>
            </div>
        </div>
    </div>
