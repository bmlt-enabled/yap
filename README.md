...
> **Upgrading from Yap 4.x?** Read the [4.x → 5.x upgrade guide](https://yap.bmlt.app/miscellaneous/upgrading-from-yap-4x-to-yap-5x) before deploying. Back up your database before upgrading.
