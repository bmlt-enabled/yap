...
class SettingsService
{
    ...
    private array $allowlist = [
        ...
        'bmlt_auth' => ['description' => '/general/01-setup' , 'default' => true, 'overridable' => false, 'hidden' => false],
        'call_routing_filter' => ['description' => '/helpline/helpline-call-routing' , 'default' => '', 'overridable' => true, 'hidden' => false],
        ...
        'digit_map_search_type' => ['description' => '/general/menu-options', 'default' => ['1' => SearchType::VOLUNTEERS, '2' => SearchType::MEETINGS, '3' => SearchType::JFT, '4' => SearchType::SPAD, '9' => SearchType::DIALBACK], 'overridable' => true, 'hidden' => false],
        'digit_map_location_search_method' => ['description' => '/general/menu-options', 'default' => ['1' => LocationSearchMethod::VOICE, '2' => LocationSearchMethod::DTMF, '3' => SearchType::JFT, '4' => SearchType::SPAD], 'overridable' => true, 'hidden' => false],
        ...
        'pronunciations' => ['description' => '/meeting-search/pronunciations', 'default' => [], 'overridable' => true, 'hidden' => false],
        ...
        'service_body_id' => ['description' => '/general/configuration-precedence', 'default' => null, 'overridable' => true, 'hidden' => false],
        ...
        'tomato_url' => ['description' => '/meeting-search/tomato-meeting-search' , 'default' => 'https://aggregator.bmltenabled.org/main_server', 'overridable' => true, 'hidden' => false],
        ...
        'voicemail_playback_grace_hours' => ['description' => '/helpline/voicemail', 'default' => 48, 'overridable' => true, 'hidden' => false],
        'volunteer_auto_answer' => ['description' => '/helpline/volunteer-auto-answer', 'default'=>false, 'overridable' => true, 'hidden' => false],
        'word_language' => ['description' => '/general/language-options', 'default' => 'en-US', 'overridable' => true, 'hidden' => false],
        'webrtc_enabled' => ['description' => '/miscellaneous/experimental-web-widgets', 'default' => false, 'overridable' => false, 'hidden' => false],
