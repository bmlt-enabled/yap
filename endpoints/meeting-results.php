...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo sprintf("%scroutonjs/yap-meeting-results.min.css", $filePath) ?>" />
    <style type="text/css">
        #bmlt-map { display: none; }
    </style>
    <script src="<?php echo sprintf("%scroutonjs/yap-meeting-results.min.js", $filePath) ?>"></script>
