...
<?php if (count($participants) > 0) {
    ...
    <Gather numDigits="1" timeout="15" action="helpline-answer-response.php?conference_name=<?php echo $_REQUEST['conference_name'] . getConfigFileOverrideString(true)?>" method="GET">
